...
$sql="SELECT * FROM ingredient_type $search order by title LIMIT {$startpoint}, {$limit}";
$stmt=$conn->prepare($sql);
$stmt->execute();
$result=$stmt->fetchAll(PDO::FETCH_ASSOC);

$sql1="SELECT id FROM ingredient_type";
...
<div class="col-md-4">
<h3><i class="fa fa-angle-right"></i> Ingredient Types </h3>
</div>
...
<div class="col-md-5" style="text-align:right;">			
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 mb">
              <div class="content-panel pn">
                <a href="edit_ingredient_type.php?id=<?php echo $value['id'];?>" style="color:white">
                ...
                <div class="profile-01 centered" style="padding-left:10px; padding-right:10px;">
                  <a href="#myModal20" data-toggle="modal" data-target="#myModal20" 
                  class="del_ing_type" vid="<?php echo $value['id'];?>" style="color:white" ><p><?php echo strtoupper($value['title']);?></p></a>
                </div>
               </div><! --/content-panel -->
            </div><! --/col-md-4 -->
            <?php }?>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2015 -- recipes
              <a href="list_ingredient_type.php#" class="go-top">
...
<script>
$('.del_ing_type').on('click', function (e) { 
...
$('#inside20').append(data).fadeIn(1000);
});
}); 
</script>
          ...
          <div class="modal-content">
              <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Do You Really Want To Delete The Ingredient Type ?</h4>
                      </div>
