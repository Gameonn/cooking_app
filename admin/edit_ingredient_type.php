...
$sql2="SELECT * FROM ingredient_type WHERE id=:id";
      ...
      <section id="container" >
        ...
        <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Edit Ingredient type </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" id="recipe" method="POST" action="eventHandler.php" enctype='multipart/form-data'>
                          <input type="hidden" class="form-control" name="action" value="edit_ingre_type" >
                          <input type="hidden" class="form-control" name="id" value="<?php echo $id;?>">

                          <div class="form-group">
						               <label class="col-sm-3 control-label">Ingredient Type Name: </label>
						               <div class="col-sm-9">
            						      <input class=" form-control" type="text" name="ingredient_type_name" value="<?php echo $result1[0]['title'];?>">
            						    </div>
            			  </div>
                          
						  <div class="form-group">
							      <label class="col-sm-3 control-label">Ingredient Type Image: </label>
...
<footer class="site-footer">
  <div class="text-center">
      2015 -- recipes
      <a href="edit_ingredient_type.php#" class="go-top">
