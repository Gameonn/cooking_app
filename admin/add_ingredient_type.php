      ...
      <section id="container" >
        ...
        <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Ingregient Types</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" id="recipe" method="POST" action="eventHandler.php" enctype='multipart/form-data'>
                          <input type="hidden" class="form-control" name="action" value="ingredient_type" >
                          ...
                          <div class="form-group">
                             <label class="col-sm-2 col-sm-2 control-label">Generic</label>
                              <div class="col-sm-10">
                              <select class="form-control" name="ing_class" required> 
